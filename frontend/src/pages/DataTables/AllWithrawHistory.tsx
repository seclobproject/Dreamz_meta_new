...
import { getAllWithdrawHistory } from '../../store/adminSlice';

function AllWithrawHistory() {
    const dispatch = useAppDispatch();
    const { data: rowData, error } = useAppSelector((state: any) => state.getAllWithdrawHistoryReducer);
    
    console.log(rowData,"reowdatadd");
    ...
    useEffect(() => {
        dispatch(setPageTitle('All Withraw History'));
    });
   ...
   <div className="space-y-6">
            ...
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">All Withdraw History</h5>
...
export default AllWithrawHistory