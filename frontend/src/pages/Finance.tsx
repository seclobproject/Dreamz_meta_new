...
const Finance = () => {
    ...
    const handleClick = () => {
        const url = `https://ecard.dreamzmeta.com/admin/login/Q9424TX8068ED08WQH22FI448`;
        window.location.href = url;
    };
    const handleClickUser = () => {
        const url = `https://ecard.dreamzmeta.com/member/login/Q9424TX8068ED08WQH22FI448/${userInfo?._id}`;
        window.location.href = url;
    };
